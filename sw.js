...
const ASSETS = ['./', './index.html', './admin.html', './style.css', './db.js', './app.js', './admin.js', './manifest.json', './icons/icon-192.png', './icons/icon-512.png', './assets/logo-pae.png', './assets/logo-org.png'];
